function EntryPoint_neuropxl(data_dir)
...
rootH = strrep(data_dir,'/om4/group/jazlab/rishir/data/', '/om/user/rishir/data/'); % path to temporary binary file (same size as data, should be on fast SSD)rootKS = strcat(rootZ, ks_output_dname);
