...
%ops.chanMap             = '/om/user/rishir/lib/KiloSort/configFiles/chanMap_vprobe64.mat'; % make this file using createChannelMapFile.m
...
%ops.maxFR               = 50000;  % maximum number of spikes to extract per batch (20000)
...
%ops.initialize      = 'fromData'; %'fromData' or 'no', default is 'no'
...
%ops.epu     = Inf;
%
%ops.ForceMaxRAMforDat   = 4e9; % maximum RAM the algorithm will try to use; on Windows it will autodetect.
%
